    ...
    <div class="crop">
        ...
        <h1 data-aos="fade-up">Attendances</h1>
            ...
            <form action="./query/querySignIn.php" method="post">
                ...
                <div class="btn-login">
                    <a href="./loading/success.php"><button name="btnCheckIn"  class="btnLogIn">CheckIn</button></a>
                    <a href="./loading/success.php"><button name="btnCheckOut"  class="btnLogIn">CheckOut</button></a>
                </div>
        </div>
